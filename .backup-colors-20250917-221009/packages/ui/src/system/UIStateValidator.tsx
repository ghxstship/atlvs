...
export const ValidationReporter: React.FC<ValidationReporterProps> = ({
  ...
  return (
    <div
      className={`fixed ${positionClasses[position]} z-[9999] bg-black/90 text-white rounded-lg shadow-2xl backdrop-blur-sm transition-all duration-300 ${
    ...
    >
      <div className="p-sm border-b border-white/20 flex justify-between items-center">
        ...
        <button
          ...
          className="text-xs px-sm py-xs rounded hover:bg-white/10"
        >
      ...
      {!isMinimized && (
        <div className="p-sm max-h-96 overflow-y-auto">
          <div className="mb-sm text-sm">
            ...
            <div className="flex justify-between mb-xs">
              <span>Valid:</span>
              <span className="font-mono text-green-400">{validComponents}</span>
            </div>
            <div className="flex justify-between">
              <span>Invalid:</span>
              <span className="font-mono text-red-400">{totalComponents - validComponents}</span>
            </div>
          </div>
              ...
              return (
                <div
                  ...
                  className={`p-sm rounded text-xs ${
                    isComponentValid ? 'bg-green-500/20' : 'bg-red-500/20'
                  }`}
                >
