...
export class DataFetchingComponent<T, P extends DataFetchingProps<T> = DataFetchingProps<T>> 
  ...
  protected renderContent(): React.ReactNode {
    ...
    if (error && !data) {
      return (
        <Card className="p-lg border-red-200 bg-red-50">
          <div className="flex items-start space-x-sm">
            <AlertCircle className="h-6 w-6 text-red-600 flex-shrink-0 mt-0.5" />
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-red-800 mb-sm">Data Loading Error</h3>
              <p className="text-red-700 mb-md">{error.message}</p>
