...
const DefaultLoadingFallback: React.FC = () => (
  <Card className="p-xl flex items-center justify-center">
    <RefreshCw className="h-6 w-6 animate-spin text-blue-600 mr-sm" />
  ...
  <Card className="p-xl border-red-200 bg-red-50">
    <div className="flex items-start space-x-sm">
      ...
      <div className="flex-1">
        <h3 className="text-lg font-semibold text-red-800 mb-sm">Component Load Error</h3>
        <p className="text-red-700 mb-md">
          Failed to load component: {error.message}
        </p>
        <button
          onClick={retry}
          className="px-md py-sm bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors"
        >
          Retry Loading
        </button>
      </div>
