  ...
  return (
    <div className="fixed top-20 right-4 z-50 space-y-sm">
      {topPredictions.map(prediction => (
        <div
          key={prediction.id}
          className="bg-card border border-border rounded-lg shadow-lg p-sm max-w-sm animate-slide-in-right"
        >
...
export function ContextualActions() {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50">
      <div className="bg-card border border-border rounded-lg shadow-lg p-md max-w-sm">
