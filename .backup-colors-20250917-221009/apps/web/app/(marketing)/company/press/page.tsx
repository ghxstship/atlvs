    ...
    <div className="min-h-screen">
      ...
      <section className="py-4xl">
        <div className="container mx-auto px-md">
          ...
          <Card className="overflow-hidden hover:shadow-lg transition-shadow mb-2xl">
            ...
            {mediaCoverage.map((article, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow group">
                <CardContent className="p-lg">
                  ...
                  <h3 className={`${anton.className} text-body text-heading-3 mb-sm uppercase group-hover:color-primary transition-colors`}>
                    {article.title}
                  </h3>
                ...
                <CardContent className="p-lg">
                  <div className="flex items-start gap-md">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="color-primary text-heading-4 mb-sm">{award.organization}</p>
