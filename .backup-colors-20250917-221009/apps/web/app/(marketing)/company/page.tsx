          ...
          <div className="grid md:grid-cols-4 gap-xl max-w-4xl mx-auto">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className={`${anton.className} text-heading-2 lg:text-heading-1 text-heading-3 color-primary mb-sm`}>
                  {stat.value}
                </div>
            ...
            {leadership.map((member) => (
              <Card key={member.name} className="text-center" interactive>
                <CardContent className="p-xl">
                  ...
                  <div className="color-primary text-heading-4 mb-md">{member.role}</div>
                ...
                <CardContent className="p-lg">
                  <div className="flex items-start justify-between gap-lg">
                    <div className="flex-1">
                      <h3 className="text-heading-4 color-foreground mb-sm hover:color-primary transition-colors">
                        {press.title}
                      </h3>
