            ...
            <div>
              ...
              <div className="stack-md">
                <div className="flex items-start gap-sm">
                  <Target className="h-5 w-5 color-primary flex-shrink-0 mt-xs" />
                  <div>
                ...
                <div className="flex items-start gap-sm">
                  <Users className="h-5 w-5 color-primary flex-shrink-0 mt-xs" />
                  <div>
                ...
                <div className="flex items-start gap-sm">
                  <TrendingUp className="h-5 w-5 color-primary flex-shrink-0 mt-xs" />
                  <div>
                  ...
                  <div className={`flex-1 ${index % 2 === 0 ? 'text-right' : 'text-left'}`}>
                    <Card className="hover:shadow-lg transition-shadow">
                      <CardContent className="p-lg">
                        <div className={`mb-sm color-primary ${typography.statValue}`}>
                          {milestone.year}
                        </div>
            ...
            {leadership.map((leader) => (
              <Card key={leader.name} className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-lg">
                  ...
                  <p className="text-body-sm text-heading-4 color-primary mb-sm">{leader.role}</p>
            ...
            {[
              ...
              <Card key={award.title} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-lg text-center">
                  ...
                  <p className="text-body-sm text-heading-4 color-primary mb-sm">{award.organization}</p>
            ...
            {[
              ...
              <a key={link.title} href={link.href as any as any}>
                <Card className="hover:shadow-lg transition-shadow group">
                  <CardContent className="p-lg text-center">
                    <h3 className={`mb-sm group-hover:color-primary transition-colors ${typography.cardTitle}`}>
                      {link.title}
                    </h3>
