          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-xl">
              <div className="text-center">
                ...
                <p className="text-body text-heading-4 color-primary mb-sm">OPVS Talent Management</p>
                      ...
                      <div className="grid gap-sm">
                        {product.features.map((feature, idx) => (
                          <div key={idx} className="flex items-start gap-sm">
                            <Zap className="h-4 w-4 color-primary mt-xs flex-shrink-0" />
        ...
        <div className="container mx-auto px-md">
          ...
          <div className="text-center">
            <Card className="max-w-2xl mx-auto">
              <CardContent className="p-xl">
                <MessageSquare className="h-12 w-12 color-primary mx-auto mb-md" />
