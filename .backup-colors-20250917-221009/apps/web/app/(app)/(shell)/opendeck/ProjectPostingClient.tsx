...
export default function ProjectPostingClient({ userId, orgId }: ProjectPostingClientProps) {
  ...
  const ProjectCard = ({ project }: { project: any }) => (
    <Card className="p-lg hover:shadow-lg transition-shadow">
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="p-lg stack-md">
          <div>
            ...
            />
            {errors.title && (
              <p className="text-body-sm color-destructive mt-xs">{errors.title.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.description && (
              <p className="text-body-sm color-destructive mt-xs">{errors.description.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.scope && (
              <p className="text-body-sm color-destructive mt-xs">{errors.scope.message}</p>
            )}
          </div>
