  ...
  return (
    <section className="py-smxl bg-background">
      <div className="container mx-auto px-lg px-md">
        ...
        {/* Case Studies */}
        <div className="mb-xl">
          <h3 className="font-title text-heading-3 text-heading-3 text-center mb-md">
            SUCCESS STORIES
          </h3>
            ...
            {caseStudies.map((study) => (
              <Card key={study.company} className="hover:shadow-floating transition-shadow">
                <CardContent className="p-lg">
                  ...
                  {/* Challenge */}
                  <div className="mb-sm">
                    <h4 className="text-heading-4 text-body-sm color-muted mb-xs">
                      CHALLENGE
                    </h4>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-xl text-center">
          <div>
            <div className="font-title text-heading-2 text-heading-3 color-foreground mb-xs">98%</div>
            <div className="text-body-sm color-muted">Client Satisfaction</div>
          </div>
          <div>
            <div className="font-title text-heading-2 text-heading-3 color-foreground mb-xs">40%</div>
            <div className="text-body-sm color-muted">Average Time Saved</div>
          </div>
          <div>
            <div className="font-title text-heading-2 text-heading-3 color-foreground mb-xs">$2M+</div>
            <div className="text-body-sm color-muted">Cost Savings Generated</div>
          </div>
          <div>
            <div className="font-title text-heading-2 text-heading-3 color-foreground mb-xs">24/7</div>
