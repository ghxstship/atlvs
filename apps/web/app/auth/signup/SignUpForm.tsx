  ...
  return (
    <div>
      ...
      <div className="space-y-3">
        <Button variant="outline" size="lg" className="w-full" disabled={pending} onClick={onGoogle}>
        ...
        <Button variant="outline" size="lg" className="w-full" disabled={pending} onClick={onGitHub}>
