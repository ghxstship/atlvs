      ...
      >
        <form id="contract-form" onSubmit={handleSubmit(onSubmit)} className="stack-lg">
          ...
          <div className="stack-md">
            ...
            <div className="grid grid-cols-2 gap-md">
              ...
              <div>
                ...
                <Input                   {...register('contractorEmail')}
                  type="email"
            ...
            <div className="grid grid-cols-2 gap-md">
              <div>
                ...
                <Input                   {...register('contractorPhone')}
              ...
              <div>
                ...
                <Input                   {...register('contractorCompany')}
            ...
            <div className="grid grid-cols-3 gap-md">
              ...
              <div>
                ...
                <Input                   {...register('maxHours', { valueAsNumber: true })}
                  type="number"
                  min="1"
                  placeholder="40"
                />
            ...
            <div className="grid grid-cols-2 gap-md">
              <div>
                ...
                <Input                   {...register('terminationNotice', { valueAsNumber: true })}
                  type="number"
                  min="1"
                  placeholder="14"
                />
              ...
              <div>
                {autoRenewal && (
                  <div>
                    ...
                    <Input                       {...register('renewalPeriod', { valueAsNumber: true })}
                      type="number"
                      min="1"
                      placeholder="12"
                    />
          ...
          <div className="bg-warning/5 p-md rounded-lg">
            <h4 className="form-label color-warning mb-sm">Contract Guidelines</h4>
