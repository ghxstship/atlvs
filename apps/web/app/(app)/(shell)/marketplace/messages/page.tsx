...
export default async function MessagesPage() {
 ...
 {orgId && user ? (
 <MessagesClient orgId={orgId} userId={user.id} />
 ) : (
 <div className="brand-marketplace text-center py-xsxl">
 <h2 className="text-heading-3 mb-md">Marketplace Messages</h2>
 <p className="color-muted">Please sign in to access marketplace messages</p>
 </div>
 )}
 </div>
 </FeatureGate>
