...
export default async function PaymentsPage() {
 ...
 {orgId && user ? (
 <PaymentsClient orgId={orgId} userId={user.id} />
 ) : (
 <div className="brand-marketplace text-center py-2xl">
 <h2 className="text-heading-3 mb-md">Marketplace Payments</h2>
 <p className="color-muted">Please sign in to access marketplace payments</p>
 </div>
 )}
 </div>
 </FeatureGate>
