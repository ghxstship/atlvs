...
export type TransactionViewType = 'grid' | 'list' | 'kanban' | 'calendar';

interface TransactionViewSwitcherProps {
  currentView: TransactionViewType;
  onViewChange: (view: TransactionViewType) => void;
}

export default function TransactionViewSwitcher({ currentView, onViewChange }: TransactionViewSwitcherProps) {
  const views = [
