...
export default function TransactionChartView({ data, isLoading, onRecordClick }: TransactionChartViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">ChartView visualization for transactions - Coming Soon</p>
