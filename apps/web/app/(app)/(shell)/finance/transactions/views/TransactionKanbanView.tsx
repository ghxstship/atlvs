...
export default function TransactionKanbanView({ data, isLoading, onRecordClick }: TransactionKanbanViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">KanbanView visualization for transactions - Coming Soon</p>
