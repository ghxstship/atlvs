...
export default function TransactionCalendarView({ data, isLoading, onRecordClick }: TransactionCalendarViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">CalendarView visualization for transactions - Coming Soon</p>
