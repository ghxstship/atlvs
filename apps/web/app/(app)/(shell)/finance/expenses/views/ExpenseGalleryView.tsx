...
interface ExpenseGalleryViewProps {
  data: unknown[];
  isLoading?: boolean;
  onRecordClick?: (record: unknown) => void;
}

export default function ExpenseGalleryView({ data, isLoading, onRecordClick }: ExpenseGalleryViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">GalleryView visualization for expenses - Coming Soon</p>
