...
interface BudgetGalleryViewProps {
  data: unknown[];
  isLoading?: boolean;
  onRecordClick?: (record: unknown) => void;
}

export default function BudgetGalleryView({ data, isLoading, onRecordClick }: BudgetGalleryViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">GalleryView visualization for budgets - Coming Soon</p>
