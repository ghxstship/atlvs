...
export default function BudgetChartView({ data, isLoading, onRecordClick }: BudgetChartViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">ChartView visualization for budgets - Coming Soon</p>
