...
import CreateRevenueDrawer from '../drawers/CreateRevenueDrawer';
...
export default function CreateRevenueClient({ user, orgId }: CreateRevenueClientProps) {
 ...
 <div>
 <h1 className="text-3xl font-bold">Create Revenue</h1>
 <p className="text-gray-600">Add a new revenue entry to track financial performance.</p>
 </div>
 </div>
 ...
 <p className="text-green-700 mt-xs">Revenue entry created successfully. Redirecting...</p>
 </Alert>
 )}
 ...
 <div>
 <h3 className="font-semibold mb-sm">Revenue Entry Guidelines</h3>
 <ul className="text-sm text-gray-600 space-y-xs">
 <li>• Enter accurate revenue amounts and recognition dates</li>
 <li>• Associate with clients and projects when applicable</li>
 <li>• Use appropriate categories for proper classification</li>
 <li>• Include invoice numbers for invoiced revenue</li>
 </ul>
 </div>
 </div>
 </CardContent>
