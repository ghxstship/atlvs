...
export default function ufinancePage() {
  // TODO: Implement ufinance content using ListLayout + BoardView
  // This is a placeholder - actual implementation needed

  return (
    <ListLayout
      title="ufinance"
      subtitle="Manage and track all your ufinance"
      actions={
