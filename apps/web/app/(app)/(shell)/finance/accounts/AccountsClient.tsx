      ...
      <div className="stack-lg">
        ...
        {currentView === 'grid' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md">
            {accounts.map((account: any) => {
              ...
              return (
                <Card key={account.id} className="p-lg hover:shadow-elevated transition-shadow cursor-pointer" onClick={() => handleViewAccount(account)}>
        ...
        {reconcileDrawerOpen && selectedAccount && (
          <div className="fixed inset-0 bg-foreground/30 backdrop-blur-sm z-50 flex items-center justify-center">
            <Card className="w-full max-w-md mx-md p-lg">
              ...
              <div className="stack-md">
                <div>
                  <p className="text-body-sm color-foreground/70 mb-sm">Account: {selectedAccount.name}</p>
                  <p className="text-body-sm color-foreground/70 mb-sm">Current Balance: {formatCurrency(selectedAccount.balance, selectedAccount.currency)}</p>
                </div>
                ...
                <div className="bg-secondary p-sm rounded-md">
