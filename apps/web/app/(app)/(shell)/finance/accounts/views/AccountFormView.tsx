...
export default function AccountFormView({ data, isLoading, onRecordClick }: AccountFormViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">FormView visualization for accounts - Coming Soon</p>
