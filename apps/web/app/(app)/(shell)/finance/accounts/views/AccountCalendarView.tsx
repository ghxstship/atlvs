...
export default function AccountCalendarView({ data, isLoading, onRecordClick }: AccountCalendarViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">CalendarView visualization for accounts - Coming Soon</p>
