...
export type InvoiceViewType = 'grid' | 'list' | 'kanban' | 'calendar';

interface InvoiceViewSwitcherProps {
  currentView: InvoiceViewType;
  onViewChange: (view: InvoiceViewType) => void;
}

export default function InvoiceViewSwitcher({ currentView, onViewChange }: InvoiceViewSwitcherProps) {
  const views = [
