...
export default function InvoiceListView({ data, isLoading, onRecordClick }: InvoiceListViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">ListView visualization for invoices - Enterprise Implementation</p>
