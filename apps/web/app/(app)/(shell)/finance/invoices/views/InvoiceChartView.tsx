...
export default function InvoiceChartView({ data, isLoading, onRecordClick }: InvoiceChartViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">ChartView visualization for invoices - Enterprise Implementation</p>
