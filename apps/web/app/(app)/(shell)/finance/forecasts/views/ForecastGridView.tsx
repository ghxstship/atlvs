...
interface ForecastGridViewProps {
  data: unknown[];
  isLoading?: boolean;
  onRecordClick?: (record: unknown) => void;
}

export default function ForecastGridView({ data, isLoading, onRecordClick }: ForecastGridViewProps) {
  if (isLoading) {
  ...
  return (
    <Card className="p-lg">
      <div className="text-center py-xl">
        ...
        <p className="text-gray-600">GridView visualization for forecasts - Enterprise Analytics</p>
