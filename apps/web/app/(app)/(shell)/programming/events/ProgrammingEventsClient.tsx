...
import ProgrammingEventsBoardView from "./views/ProgrammingEventsBoardView";
import ProgrammingEventsListView from "./views/ProgrammingEventsListView";
import ProgrammingEventsCalendarView from "./views/ProgrammingEventsCalendarView";
import ProgrammingEventsTimelineView from "./views/ProgrammingEventsTimelineView";
...
type ProgrammingEventsClientProps = {
 orgId: string;
...
export default function ProgrammingEventsClient({
 orgId,
 currentUserId,
 initialEvents,
 projects,
 users,
}: ProgrammingEventsClientProps) {
 ...
 case 'calendar':
 return <ProgrammingEventsCalendarView events={filteredEvents} onView={openViewDrawer} onEdit={openEditDrawer} />;
 case 'timeline':
 return <ProgrammingEventsTimelineView events={filteredEvents} onView={openViewDrawer} onEdit={openEditDrawer} />;
 case 'list':
 default:
 return (
 <ProgrammingEventsListView
 events={filteredEvents}
 selected={selectedEvents}
 onSelect={toggleSelection}
 onView={openViewDrawer}
