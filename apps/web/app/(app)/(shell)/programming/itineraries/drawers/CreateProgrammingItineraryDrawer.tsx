...
type CreateProgrammingItineraryDrawerProps = {
 open: boolean;
...
export default function CreateProgrammingItineraryDrawer({
 open,
 onOpenChange,
 orgId,
 currentUserId,
 ...
 const onSubmit = async (data: CreateItineraryFormData) => {
 try {
 setLoading(true);
 ...
 open={open}
 onClose={handleClose}
 title="Create Programming Itinerary"
 size="2xl"
 >
