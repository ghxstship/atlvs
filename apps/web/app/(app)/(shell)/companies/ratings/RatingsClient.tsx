  ...
  return (
    <div className="stack-lg">
      ...
      {currentView === 'grid' ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-lg">
          {ratings.map((rating) => (
            <Card key={rating.id} className="p-lg hover:shadow-lg transition-shadow">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-heading-4 text-body">{rating.company_name}</h3>
                  <div className="flex items-center cluster-xs mt-1">
            ...
            <Card key={rating.id} className="p-lg">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center cluster mb-2">
                    <h3 className="text-heading-4 text-body">{rating.company_name}</h3>
      ...
      {ratings.length === 0 && (
        <div className="text-center py-2xl">
          <Building className="h-12 w-12 color-muted mx-auto mb-4" />
