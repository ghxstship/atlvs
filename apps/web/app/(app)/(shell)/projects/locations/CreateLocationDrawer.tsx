...
export default function CreateLocationDrawer({
 open,
 onOpenChange,
 orgId,
 projectId,
 ...
 const type = typeof data.type === "string" && data.type.trim().length > 0 ? data.type.trim() : "other";
 ...
 parking_available: parseBoolean(data.parking_available, false),
