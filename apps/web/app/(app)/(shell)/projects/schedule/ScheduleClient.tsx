    ...
    <div className="stack-lg">
            ...
            {filteredData.projects.map(project => (
              <div key={project.id} className="border rounded-lg p-md">
                ...
                {project.starts_at && project.ends_at && (
                  <div className="flex items-center gap-md text-body-sm color-muted mb-3">
      ...
      {view === 'calendar' && (
        <div className="stack-md">
          ...
          <div className="grid grid-cols-7 gap-xs text-center text-body-sm form-label color-muted mb-2">
            <div>Sun</div>
            <div>Mon</div>
            <div>Tue</div>
            <div>Wed</div>
      ...
      {/* Summary Stats */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-md pt-6 border-t">
