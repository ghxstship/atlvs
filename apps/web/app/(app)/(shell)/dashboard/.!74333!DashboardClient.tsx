...
const TempCard = ({ children, className, ...props }) => (
...
const DashboardClient: React.FC<DashboardClientProps> = ({ orgId }) => {
                ...
                <div key={index} className="flex items-center gap-sm">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-sm">
                      ...
                      {activity.module && (
                        <TempBadge variant="secondary" <span className="text-body-sm">
                          {activity.module}
                        </TempBadge>
                      )}
                    </div>
    ...
    return (
      <div className="stack-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-lg">
          {[...Array(6)].map((_, i) => (
            <TempCard key={i} className="h-component-xl animate-pulse bg-secondary/50" />
          ))}
        </div>
      </div>
    );
  ...
  return (
    <div className="stack-lg">
      ...
      {widgets.length === 0 ? (
        <TempCard className="p-xsxl text-center">
