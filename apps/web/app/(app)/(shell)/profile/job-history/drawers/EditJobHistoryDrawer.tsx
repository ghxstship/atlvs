...
import { Plus, X, Calendar, Building, Award, Star, Tag, Briefcase } from "lucide-react";
...
interface EditJobHistoryDrawerProps {
 open: boolean;
 onClose: () => void;
 onSave: (id: string, data: Partial<JobHistoryEntry>) => Promise<void>;
...
export default function EditJobHistoryDrawer({
 open,
 onClose,
 onSave,
 entry,
 ...
 open={open}
 onClose={handleClose}
 title="Edit Job History Entry"
 description="Update your professional job history entry"
 >
