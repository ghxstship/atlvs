...
interface EditHistoryDrawerProps {
 open: boolean;
 onClose: () => void;
 onSave: (id: string, data: Partial<HistoryEntry>) => Promise<void>;
...
export default function EditHistoryDrawer({
 open,
 onClose,
 onSave,
 entry,
 ...
 start_date: entry.start_date.split('T')[0], // Convert to date format
 ...
 description="Update your professional history entry"
 >
