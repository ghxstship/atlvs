...
import { User, Mail, Phone, Building, Calendar, MapPin, Shield, Save, X } from "lucide-react";
...
import type { FieldConfig, CreateProfileFormData } from '../types';
...
export default function CreateProfileDrawer({
 ...
 description="Add a new user profile to your organization"
 size="lg"
 >
