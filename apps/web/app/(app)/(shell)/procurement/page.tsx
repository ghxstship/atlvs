...
export default function uprocurementPage() {
  // TODO: Implement uprocurement content using ListLayout + BoardView
  // This is a placeholder - actual implementation needed

  return (
    <ListLayout
      title="uprocurement"
      subtitle="Manage and track all your uprocurement"
      actions={
