      ...
      <div className="stack-md">
        {loading ? (
          ...
          filteredRFPs.map((rfp) => {
            ...
            return (
              <Card key={rfp.id} className={`p-lg hover:shadow-md transition-shadow ${isLate ? 'border-destructive/20 bg-destructive/5' : isUrgent ? 'border-warning/20 bg-warning/5' : ''}`}>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
