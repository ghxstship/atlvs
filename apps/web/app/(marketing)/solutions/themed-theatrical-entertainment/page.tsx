          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center lg:text-left">
                  <div className={`${anton.className} text-heading-2 text-heading-3 color-foreground mb-2 uppercase`}>50M+</div>
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-secondary/30 rounded-lg p-3">
                      <div className="text-body-sm color-muted mb-1">Cast</div>
                    ...
                    <div className="bg-secondary/30 rounded-lg p-3">
                      <div className="text-body-sm color-muted mb-1">Rehearsals</div>
                      <div className="text-heading-4">12/15</div>
                  ...
                  <div className="space-y-2">
                    ...
                    {[
                      ...
                      { department: 'Set Design', status: '88%', color: 'bg-primary' },
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t">
                    <Camera className="w-4 h-4 color-secondary" />
