            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center lg:text-left">
                  <div className={`${anton.className} text-3xl font-bold text-foreground mb-2 uppercase`}>2M+</div>
                  <div className="text-sm text-muted-foreground">Community Members</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className={`${anton.className} text-3xl font-bold text-foreground mb-2 uppercase`}>5,000+</div>
                ...
                <div className="text-center lg:text-left">
                  ...
                  <div className="text-sm text-muted-foreground">Cultural Traditions</div>
                </div>
                <div className="text-center lg:text-left">
                  ...
                  <div className="space-y-2">
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3 text-xs">
                        ...
                        <span className="font-medium flex-1">{item.program}</span>
