        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="stack-lg">
              ...
              <div>
                <h3 className="text-heading-4 text-body mb-3">Usage Data</h3>
                <p className="color-muted mb-3">
              ...
              <div>
                <h3 className="text-heading-4 text-body mb-3">Technical Information</h3>
                <p className="color-muted mb-3">
            ...
            <Card className="bg-secondary/20">
              <CardContent className="p-lg">
                ...
                <div className="stack-md">
                  ...
                  <div>
                    <h3 className="text-heading-4 mb-2">Legal Requirements</h3>
                    <p className="text-body-sm color-muted">When required by law, court order, or to protect our rights and safety.</p>
                  </div>
                  
                  <div>
                    <h3 className="text-heading-4 mb-2">Business Transfers</h3>
          ...
          <section>
            ...
            <div className="stack-lg">
              ...
              <div>
                <h3 className="text-heading-4 text-body mb-3">Correction and Updates</h3>
                <p className="color-muted">
              ...
              <div>
                <h3 className="text-heading-4 text-body mb-3">Data Deletion</h3>
                <p className="color-muted">
              ...
              <div>
                <h3 className="text-heading-4 text-body mb-3">Marketing Communications</h3>
                <p className="color-muted">
          ...
          {/* Cookies */}
          <section>
            <h2 className="font-title text-heading-3 text-heading-3 mb-6">6. Cookies and Tracking</h2>
          ...
          <section>
            <h2 className="font-title text-heading-3 text-heading-3 mb-6">7. International Data Transfers</h2>
          ...
          {/* Changes to Policy */}
          <section>
            <h2 className="font-title text-heading-3 text-heading-3 mb-6">9. Changes to This Policy</h2>
