    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="color-muted mt-1">Manage and track your organization's resources</p>
        </div>
          ...
          <Card key={index} className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-heading-3 text-heading-3 color-foreground mt-1">{stat.value}</p>
                <p className="text-body-sm color-success mt-2">{stat.trend}</p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              {recentResources.map((resource) => (
                <div key={resource.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-secondary/50">
        ...
        <div>
          <Card className="p-6">
            <h2 className="text-body text-heading-4 color-foreground mb-4">Categories</h2>
          ...
          <Card className="p-6 mt-4">
            <h2 className="text-body text-heading-4 color-foreground mb-4">Quick Actions</h2>
      ...
      {/* Activity Timeline */}
      <Card className="p-6">
        <h2 className="text-body text-heading-4 color-foreground mb-4">Recent Activity</h2>
        <div className="space-y-4">
