...
import { ChartBar } from '../../../_components/ui/ChartBar';
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'reports' ? (
        <>
          ...
          {loading ? (
            <Card>
              <div className="p-8 text-center color-muted">Loading reports...</div>
            </Card>
      ...
      >
        <div className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-body-sm form-label mb-1">Report Title</label>
          ...
          <div>
            <label className="block text-body-sm form-label mb-1">Categories (Optional)</label>
            <Input placeholder="Select categories to include" />
          </div>
          <div>
            <label className="block text-body-sm form-label mb-1">Additional Filters</label>
            <textarea
