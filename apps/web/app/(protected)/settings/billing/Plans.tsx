      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="rounded-lg border p-4">
          ...
          <button
            ...
            className="mt-4 rounded-md bg-foreground px-3 py-2 text-body-sm text-background disabled:opacity-50"
          >
        ...
        <div className="rounded-lg border p-4">
          ...
          <div className="mt-2 flex gap-2">
            <input value={orgId} onChange={(e) => setOrgId(e.target.value)} placeholder="organizationId" className="w-full rounded-md border bg-background px-3 py-2 text-body-sm" />
          </div>
          <button
        ...
        <div className="rounded-lg border p-4">
          ...
          <a href={ENTERPRISE_CONTACT_URL} className="mt-4 inline-block rounded-md border px-3 py-2 text-body-sm">
            Contact Sales
          </a>
        </div>
      </div>
