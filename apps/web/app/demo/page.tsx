        ...
        {session && (
          <div className="mt-8 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <a 
                href="/dashboard" 
                className="inline-flex items-center px-4 py-2 bg-primary color-primary-foreground rounded-md hover:bg-primary/90 transition-colors"
              >
                Go to Dashboard
              </a>
              <a 
                href="/projects" 
                className="inline-flex items-center px-4 py-2 border border-border rounded-md hover:bg-secondary transition-colors"
              >
                View Projects
              </a>
            </div>
