      ...
      <Card title="Upgrade required">
        <div className="space-y-3 text-sm text-foreground/80">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="/settings/organization/domains" className="btn border border-zinc-300 bg-transparent hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">Manage Domains</Link>
          </div>
        </div>
      </Card>
    </div>
