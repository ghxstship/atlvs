...
export const assetsModuleConfig: ModuleConfig = {
  ...
  entities: {
    ...
    audits: {
      ...
      fields: [
        ...
        { key: 'discrepancies_found', label: 'Discrepancies', type: 'number', min: 0 },
        { key: 'completion_percentage', label: 'Completion %', type: 'number', min: 0, max: 100 },
  ...
  headerActions: [
    ...
    },
    {
      ...
      icon: Upload,
      variant: 'outline',
      onClick: () => console.log('Bulk import assets')
    },
    {
      id: 'export',
      label: 'Export',
      icon: Download,
      variant: 'outline',
      onClick: () => console.log('Export assets data')
    },
    {
      id: 'settings',
      label: 'Settings',
      icon: Settings,
      variant: 'ghost',
      onClick: () => console.log('Asset settings')
    }
  ],
