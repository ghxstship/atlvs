    ...
    variants: {
      variant: {
        ...
        secondary: [
          ...
          'hover:bg-secondary/90 hover:shadow-elevated hover:-translate-y-0.5',
        ...
        destructive: [
          'bg-destructive text-destructive-foreground shadow-surface',
          'hover:bg-destructive/90 hover:shadow-elevated hover:-translate-y-0.5',
          'focus-visible:ring-destructive',
          'active:bg-destructive/95 active:translate-y-0 active:shadow-surface',
        ],
        success: [
          'bg-success text-success-foreground shadow-surface',
          'hover:bg-success/90 hover:shadow-elevated hover:-translate-y-0.5',
          'focus-visible:ring-success',
          'active:bg-success/95 active:translate-y-0 active:shadow-surface',
        ],
        warning: [
          'bg-warning text-warning-foreground shadow-surface',
          'hover:bg-warning/90 hover:shadow-elevated hover:-translate-y-0.5',
          'focus-visible:ring-warning',
          'active:bg-warning/95 active:translate-y-0 active:shadow-surface',
        ],
      },
      size: {
...
export const cardVariants = cva(
  [
    'rounded-lg border bg-card shadow-surface transition-all duration-200',
  ],
  {
    variants: {
      variant: {
        ...
        elevated: [
          ...
          'hover:shadow-floating hover:-translate-y-1',
        ],
        interactive: [
          'border-border cursor-pointer',
          'hover:border-primary/50 hover:shadow-elevated hover:-translate-y-0.5',
...
export const animationVariants = {
  ...
  hoverLift: 'hover:-translate-y-1 hover:shadow-floating transition-all duration-200',
  hoverGlow: 'hover:shadow-floating hover:shadow-primary/25 transition-all duration-200',
};
