  ...
  'min-h-screen bg-muted',
  {
    variants: {
      type: {
        ...
        settings: 'flex flex-col lg:flex-row gap-8 p-6',
  ...
  'flex-1 overflow-auto',
  {
    variants: {
      layout: {
        ...
        single: 'max-w-4xl mx-auto px-6 py-8',
        
        // Two column layout
        split: 'grid grid-cols-1 lg:grid-cols-2 gap-8 px-6 py-8',
        
        // Three column layout
        triple: 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-6 py-8',
        
        // Full width content
        full: 'px-6 py-8',
        
        // Centered content with max width
        centered: 'max-w-7xl mx-auto px-6 py-8',
        
        // Sidebar + content
        sidebar: 'flex gap-8 px-6 py-8',
        
        // Card-based layout
        cards: 'grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-6 py-8',
      },
      padding: {
        none: 'p-0',
        sm: 'p-4',
...
const actionBarVariants = cva(
  'flex items-center justify-between p-4 bg-background border-t border-border',
  {
    variants: {
      variant: {
        default: '',
        floating: 'mx-4 mb-4 rounded-lg border shadow-lg',
      ...
      layout: {
        ...
        stack: 'flex-col space-y-3 items-stretch',
      },
      spacing: {
        tight: 'gap-2',
        normal: 'gap-3',
...
const responsiveWorkflowVariants = {
  ...
  // Responsive stack
  responsiveStack: 'flex flex-col lg:flex-row gap-4 lg:gap-8',
  
  // Responsive toolbar
  responsiveToolbar: 'flex flex-col sm:flex-row gap-2 sm:gap-4',
};
