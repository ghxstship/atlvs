  ...
  'w-full mx-auto',
  {
    variants: {
      ...
      padding: {
        none: 'px-0',
        sm: 'px-md sm:px-lg',
        md: 'px-md sm:px-lg lg:px-xl',
        lg: 'px-lg sm:px-xl lg:px-2xl',
      },
    },
    defaultVariants: {
      size: 'xl',
...
const panelVariants = cva(
  'bg-card border border-border rounded-lg shadow-surface',
  {
    variants: {
      padding: {
        none: 'p-0',
...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className={twMerge('border-b border-border pb-lg mb-xl', className)}>
      {breadcrumbs && (
        <div className="mb-md">
          {breadcrumbs}
        </div>
      ...
      <div className="flex items-start justify-between">
        <div className="min-w-0 flex-1">
          ...
          {subtitle && (
            <p className="mt-sm text-lg text-muted-foreground font-body">
              {subtitle}
            </p>
          )}
        </div>
    ...
    <div className={twMerge('min-h-screen bg-muted', className)}>
      ...
      <div className="flex flex-1">
        ...
        <main className={twMerge(
          ...
          <Container size="full" padding="md" className="py-xl">
            {children}
          </Container>
        </main>
      </div>
...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ 
  ...
  return (
    <div className={twMerge('gap-xl', className)}>
      <Header 
        title={title} 
        subtitle={subtitle} 
        actions={actions} 
...
export const DetailLayout: React.FC<DetailLayoutProps> = ({ 
  ...
  return (
    <div className={twMerge('gap-lg', className)}>
      <Header 
        title={title} 
        subtitle={subtitle} 
        actions={actions} 
