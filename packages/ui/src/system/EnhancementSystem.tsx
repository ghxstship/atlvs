...
const animationVariants = cva('', {
  variants: {
    ...
    // Hover animations
    hover: {
      lift: 'hover:-translate-y-1 hover:shadow-floating transition-all duration-200 ease-out',
      scale: 'hover:scale-105 transition-transform duration-200 ease-out',
      glow: 'hover:shadow-floating hover:shadow-primary/25 transition-all duration-200 ease-out',
    ...
    focus: {
      ...
      glow: 'focus:shadow-floating focus:shadow-primary/50 transition-all duration-200',
      scale: 'focus:scale-105 transition-transform duration-200',
      lift: 'focus:-translate-y-0.5 focus:shadow-elevated transition-all duration-200',
    },
...
const enhancedButtonVariants = cva(
  [
    ...
    // Micro-animations
    'hover:-translate-y-0.5 hover:shadow-elevated active:translate-y-0 active:scale-95',
    // Accessibility
    ...
    variants: {
      variant: {
        ...
        secondary: [
          ...
          'hover:bg-secondary/90 hover:shadow-elevated',
...
const enhancedCardVariants = cva(
  [
    'rounded-lg border bg-card shadow-surface transition-all duration-300',
    // Hover effects
  ...
  ],
  {
    variants: {
      variant: {
        ...
        elevated: 'shadow-floating hover:shadow-modal',
        interactive: [
      ...
      animation: {
        none: '',
        lift: 'hover:-translate-y-2 hover:shadow-modal',
        glow: 'hover:shadow-floating hover:shadow-primary/25',
