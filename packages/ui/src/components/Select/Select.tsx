...
export const SelectContent: React.FC<SelectContentProps> = ({ 
  ...
  return (
    <div
      className={twMerge(
        'absolute z-50 w-full rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95',
...
export const SelectLabel: React.FC<SelectLabelProps> = ({ children, className }) => {
  return (
    <div className={twMerge('py-1.5 pl-8 pr-2 text-sm font-semibold', className)}>
      {children}
    </div>
  );
};
...
export const SelectSeparator: React.FC<SelectSeparatorProps> = ({ className }) => {
  return (
    <div className={twMerge('-mx-1 my-1 h-px bg-muted', className)} />
  );
};
