  ...
  ],
  {
    variants: {
      ...
      variant: {
        default: '',
        floating: [
          'mx-2 my-2 rounded-[var(--nav-radius-lg)]',
...
export const breadcrumbVariants = cva(
  ...
  ],
  {
    variants: {
      size: {
        sm: 'text-[var(--nav-text-xs)] gap-1',
        md: 'text-[var(--nav-text-sm)] gap-[var(--nav-spacing-xs)]',
        lg: 'text-[var(--nav-text-base)] gap-[var(--nav-spacing-sm)]',
      },
      variant: {
        default: '',
        pills: '[&>*]:bg-[hsl(var(--nav-bg-secondary))] [&>*]:px-[var(--nav-spacing-sm)] [&>*]:py-1 [&>*]:rounded-full',
...
export const searchInputVariants = cva(
  ...
  ],
  {
    variants: {
      size: {
        sm: 'text-[var(--nav-text-xs)] px-2 py-1',
