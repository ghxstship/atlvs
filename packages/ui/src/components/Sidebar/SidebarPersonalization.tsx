      ...
      <div className="mx-sm mt-sm mb-sm p-sm rounded-lg bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20">
        ...
        <div className="space-y-xs">
          {insights.slice(0, 2).map((insight, index) => (
            <div
              key={index}
              className="flex items-start justify-between p-sm.5 bg-card/80 rounded-md border border-border/50 backdrop-blur-sm"
            >
              <div className="flex items-start gap-sm flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-sm mt-xs.5">
        ...
        {isLearning && (
          <div className="flex items-center gap-sm mt-sm text-xs text-muted-foreground">
