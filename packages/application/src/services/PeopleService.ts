import {
  ...
  PeopleRoleFilters,
  PeopleCompetency,
  PeopleCompetencyRepository,
  CreatePeopleCompetencyRequest,
  UpdatePeopleCompetencyRequest,
  CompetencyFilters,
  PersonCompetency,
...
export class PeopleService {
  constructor(
    ...
    private competencyRepository: PeopleCompetencyRepository,
  ...
  async getCompetencies(context: TenantContext, filters?: CompetencyFilters): Promise<PeopleCompetency[]> {
  ...
  async createCompetency(context: TenantContext, request: CreatePeopleCompetencyRequest): Promise<PeopleCompetency> {
