            ...
            >
              ...
              {selectedRecord && (
                <div className="stack-lg mt-6">
                  ...
                  <div className="grid grid-cols-2 gap-md pt-4 border-t">
                  ...
                  {selectedRecord.description && (
                    <div className="pt-4 border-t">
                      <h4 className="form-label text-body-sm mb-2 flex items-center gap-sm">
                  ...
                  {/* Quick Actions */}
                  <div className="flex gap-sm pt-4 border-t">
                    <Button>
