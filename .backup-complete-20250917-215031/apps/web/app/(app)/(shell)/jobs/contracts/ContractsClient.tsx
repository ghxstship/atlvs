      ...
      <div className="stack-md">
        {loading ? (
          ...
          filteredContracts.map((contract) => {
            ...
            return (
              <Card key={contract.id} className={`p-lg hover:shadow-md transition-shadow ${hasExpired ? 'border-destructive/20 bg-destructive/5' : isExpiring ? 'border-warning/20 bg-warning/5' : ''}`}>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="text-body text-heading-4 color-foreground mb-1 flex items-center gap-sm">
                    ...
                    <div className="flex items-center gap-lg text-body-sm color-foreground/70 mb-3">
                    ...
                    {contract.notes && (
                      <div className="mt-3 p-sm bg-accent rounded-md">
