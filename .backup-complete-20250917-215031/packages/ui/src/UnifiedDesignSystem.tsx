...
export const Card = forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant = 'default', size = 'md', interactive = false, disabled = false, ...props }, ref) => {
    const variants = {
      ...
      filled: 'border-0 bg-muted text-card-foreground shadow-sm',
    }
  ...
  ({ 
    ...
    return (
      ...
      >
        ...
        />
        <div className={cn(
          'relative bg-background rounded-lg shadow-lg w-full transition-all',
          sizes[size],
          className
        )}>
    ...
    return (
      ...
      >
        ...
        <div 
          ref={ref}
          className={cn(
            'fixed bg-background shadow-lg transition-all duration-300',
            positions[position],
            sizes[size][position],
            animations[position],
            className
  ...
  ({ 
    ...
    return (
      ...
      >
        <a 
          href="#main-content" 
          className="sr-only focus:not-sr-only focus:absolute focus:top-[var(--spacing-2)] focus:left-[var(--spacing-2)] z-50 bg-background text-foreground p-[var(--spacing-2)] rounded border shadow-lg"
        >
