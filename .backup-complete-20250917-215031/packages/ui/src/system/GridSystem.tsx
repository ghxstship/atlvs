...
const spacingVariants = cva('', {
  variants: {
    ...
    // Padding
    p: {
      0: 'p-0', 1: 'p-xs', 2: 'p-sm', 3: 'p-sm', 4: 'p-md', 5: 'p-lg', 6: 'p-lg', 8: 'p-xl', 10: 'p-2xl', 12: 'p-2xl', 16: 'p-3xl', 20: 'p-4xl', 24: 'p-5xl', 32: 'p-32',
    },
    px: {
      0: 'px-0', 1: 'px-xs', 2: 'px-sm', 3: 'px-sm', 4: 'px-md', 5: 'px-lg', 6: 'px-lg', 8: 'px-xl', 10: 'px-2xl', 12: 'px-2xl', 16: 'px-3xl', 20: 'px-4xl', 24: 'px-24', 32: 'px-32',
    },
    py: {
      0: 'py-0', 1: 'py-xs', 2: 'py-sm', 3: 'py-sm', 4: 'py-md', 5: 'py-lg', 6: 'py-lg', 8: 'py-xl', 10: 'py-2xl', 12: 'py-2xl', 16: 'py-3xl', 20: 'py-4xl', 24: 'py-5xl', 32: 'py-32',
    },
    pt: {
    ...
    spaceX: {
      0: 'space-x-0', 1: 'gap-xs', 2: 'gap-sm', 3: 'gap-sm', 4: 'gap-md', 5: 'space-x-5', 6: 'gap-lg', 8: 'gap-xl', 10: 'space-x-10', 12: 'space-x-12', 16: 'space-x-16',
    },
    spaceY: {
      0: 'space-y-0', 1: 'gap-xs', 2: 'gap-sm', 3: 'gap-sm', 4: 'gap-md', 5: 'space-y-5', 6: 'gap-lg', 8: 'gap-xl', 10: 'gap-2xl', 12: 'gap-2xl', 16: 'gap-3xl',
    },
  },
});
