...
const toastVariants = cva(
  'group pointer-events-auto relative flex w-full items-center justify-between gap-md overflow-hidden rounded-lg border p-md shadow-lg transition-all duration-300',
  {
    variants: {
      variant: {
        default: [
