...
const RouteLoadingFallback: React.FC<{ routeName: string; icon?: React.ReactNode }> = ({ 
  ...
  <Card className="p-12 flex flex-col items-center justify-center min-h-[400px]">
    ...
    <h3 className="text-xl font-semibold text-gray-900 mb-2">Loading {routeName}</h3>
  ...
  if (!config) {
    return (
      <Card className="p-8 border-red-200 bg-red-50">
        <h3 className="text-lg font-semibold text-red-800 mb-2">Route Not Found</h3>
...
export const BundleSizeMonitor: React.FC = () => {
  ...
  return (
    <Card className="p-4 mb-4 bg-yellow-50 border-yellow-200">
      <h4 className="font-semibold text-yellow-800 mb-2">Bundle Monitor (Dev Only)</h4>
