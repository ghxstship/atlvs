  ...
  const generateMockViolations = useCallback((): DesignTokenViolation[] => {
    return [
      ...
      },
      {
        ...
        severity: 'info',
        category: 'spacing',
        suggestion: 'Consider using m-3 class for consistent spacing'
      }
    ];
  }, []);
  ...
  return (
    <div className={containerClasses}>
      ...
      <div className="p-md gap-lg">
        ...
        {/* Violations List */}
        <div>
          <h4 className="font-medium mb-3 flex items-center gap-sm">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="gap-xs text-sm">
                      ...
                      <div>
                        ...
                        <code className="ml-1 px-xs py-0.5 bg-muted rounded text-xs">
                          {violation.value}
                        </code>
                      </div>
                      <div>
                        <span className="font-medium">Expected:</span> 
                        <code className="ml-1 px-xs py-0.5 bg-primary/10 rounded text-xs">
