          ...
          {showSearch && (
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-sm border border-border rounded-md bg-background text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              />
            </div>
          )}
            ...
            <div className="flex items-center gap-xs">
              ...
              >
                ...
                {state.filters.length > 0 && (
                  <span className="ml-1 px-xs.5 py-0.5 text-xs bg-primary/10 text-primary rounded">
