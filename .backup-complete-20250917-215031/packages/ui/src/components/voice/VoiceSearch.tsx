...
export function VoiceSearch({
  ...
  return (
    <div className={cn('flex items-center space-x-2', className)}>
      ...
      {/* Voice commands help */}
      {isListening && (
        <div className="absolute top-full left-0 right-0 mt-2 p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 animate-fade-in-up">
  ...
  return (
    <div className={cn('relative flex items-center', className)}>
      <input
        ...
        className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white"
      />
