        ...
        <div className="stack-md">
          ...
          {showCreateForm && (
            <div className="border border-border rounded-lg p-md bg-secondary/50">
              <h3 className="text-body form-label color-foreground mb-2">No roles found</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
                ...
                <div className="md:col-span-2">
                  <textarea
                    ...
                    className="w-full pl-10 pr-4 py-sm border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
                    rows={2}
                  />
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md">
            {filteredRoles.map((role) => (
              <div
                key={role.id}
                className="border border-border rounded-lg p-md hover:shadow-md transition-shadow"
              >
                ...
                <div className="stack-sm mb-3">
                  {role.level && (
                    <div className="flex items-center justify-between">
                      <span className="text-body-sm px-sm py-xs bg-secondary color-muted rounded">{role.level}</span>
                  ...
                  {role.department && (
                    <div className="flex items-center justify-between">
                      <p className="text-body-sm color-muted mt-1">{role.description}</p>
                ...
                {role.description && (
                  <p className="text-body-sm color-muted mt-2">Create your first role to get started.</p>
                )}
          ...
          {filteredRoles.length === 0 && (
            <div className="text-center py-2xl">
              <Users className="h-12 w-12 color-muted mx-auto mb-4" />
