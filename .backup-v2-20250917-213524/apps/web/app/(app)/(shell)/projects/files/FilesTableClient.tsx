  ...
  return (
    <div className="overflow-x-auto">
      ...
      >
        ...
        <div className="mb-3">
          <div className="mb-1 flex items-center gap-sm text-body-sm form-label"><Tag className="h-4 w-4" /> {t('tags.title')}</div>
        ...
        <div className="mt-3 flex items-center justify-between gap-sm border-t pt-3">
