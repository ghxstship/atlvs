                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start gap-md">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-sm color-muted mb-2">
                        <Building className="h-4 w-4" />
                        <span>{job.company_name}</span>
                        {job.department && <span>• {job.department}</span>}
                      </div>
                      
                      <div className="flex items-center gap-md text-body-sm color-muted mb-2">
                      ...
                      {job.location && (
                        <div className="flex items-center gap-xs text-body-sm color-muted mb-2">
