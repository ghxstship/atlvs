            ...
            return (
              <Card key={record.id}>
                <div className="p-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-md mb-4">
                    <div>
                      ...
                      <div className="flex items-center gap-xs text-body-sm color-muted mt-1">
                  ...
                  {record.notes && (
                    <div className="mb-4 p-sm bg-secondary rounded-lg">
