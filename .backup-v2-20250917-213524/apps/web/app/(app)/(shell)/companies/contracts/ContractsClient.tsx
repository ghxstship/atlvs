      ...
      <div className="stack-lg">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Manage contracts and agreements with companies</p>
          </div>
        ...
        {currentView === 'grid' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md">
            {contracts.map((contract) => (
              <Card key={contract.id} className="p-lg hover:shadow-md transition-shadow cursor-pointer" onClick={() => handleViewContract(contract)}>
