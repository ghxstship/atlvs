      ...
      <div className="container mx-auto px-lg px-md">
          ...
          {products.map((product) => (
            <Card key={product.id} className="group hover:shadow-2xl transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-xl">
                {/* Product Header */}
                <div className="mb-md">
                  <div className="flex items-center gap-2xl mb-sm">
                ...
                {/* Features Grid */}
                <div className="grid grid-cols-2 gap-2xl mb-md">
                  {product.features.map((feature) => {
                    const Icon = feature.icon;
                    return (
                      <div key={feature.label} className="flex items-start gap-2xl">
                ...
                {/* Stats */}
                <div className="grid grid-cols-3 gap-2xl mb-md p-md bg-secondary/30 rounded-lg">
        ...
        <div className="text-center">
          <Card className="max-w-4xl mx-auto bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20">
            <CardContent className="p-xl">
              <div className="flex items-center justify-center gap-2xl mb-md">
              ...
              <div className="flex flex-col sm:flex-row gap-2xl justify-center">
