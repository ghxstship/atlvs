  ...
  const generateMockViolations = useCallback((): DesignTokenViolation[] => {
    return [
      ...
      },
      {
        ...
        property: 'padding',
        value: '8px 16px',
        expectedToken: 'px-4 py-2',
        severity: 'warning',
        category: 'spacing',
        suggestion: 'Replace hardcoded padding with Tailwind classes px-4 py-2'
      },
      {
        id: 'v4',
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div>
                        ...
                        <code className="ml-1 px-1 py-0.5 bg-primary/10 rounded text-xs">
