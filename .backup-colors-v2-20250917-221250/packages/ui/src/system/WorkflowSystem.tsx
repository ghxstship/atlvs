  ...
  'relative',
  {
    variants: {
      variant: {
        ...
        minimal: 'p-md',
        card: 'p-lg bg-card border border-border rounded-lg shadow-sm',
...
const actionBarVariants = cva(
  'flex items-center justify-between p-md bg-background border-t border-border',
  {
    variants: {
      variant: {
        default: '',
        floating: 'mx-md mb-md rounded-lg border shadow-lg',
...
const notificationVariants = cva(
  'relative p-md rounded-lg border shadow-sm transition-all duration-300',
  {
    variants: {
      variant: {
