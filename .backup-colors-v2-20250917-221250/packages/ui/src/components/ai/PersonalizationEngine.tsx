...
export function AISuggestion({ suggestion, onApply, onDismiss }: AISuggestionProps) {
  ...
  return (
    <div className="p-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm">
      <div className="flex items-start justify-between mb-sm">
        <div className="flex items-center space-x-sm">
          <h4 className="text-sm font-medium text-gray-900 dark:text-white">
            {suggestion.title}
          </h4>
          <span className={`px-sm py-xs rounded-full text-xs font-medium ${impactColors[suggestion.impact]}`}>
      ...
      <p className="text-sm text-gray-600 dark:text-gray-300 mb-sm">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-sm">
          {suggestion.dismissible && (
            <button
              onClick={onDismiss}
              className="px-sm py-xs text-xs text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"
            >
              Dismiss
            </button>
          )}
          <button
            onClick={onApply}
            className="px-sm py-xs text-xs bg-blue-600 text-white rounded hover:bg-blue-700"
          >
            Apply
          </button>
        </div>
...
export function LearningProgress() {
  ...
  return (
    <div className="fixed bottom-4 right-4 p-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
      <div className="flex items-center space-x-sm">
        <div className="animate-pulse">
          <div className="w-3 h-3 bg-blue-600 rounded-full"></div>
        </div>
        <div className="flex-1">
          <div className="text-sm font-medium text-gray-900 dark:text-white mb-xs">
