            ...
            >
              <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-xl p-lg bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg border border-primary/20">
                  <h2 className="text-lg font-semibold text-primary mb-sm">
                    🚀 2026-Ready Features
                  </h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
                    <div>
                      <h3 className="font-medium text-primary mb-sm">Performance</h3>
                    ...
                    <div>
                      <h3 className="font-medium text-primary mb-sm">Accessibility</h3>
                      <ul className="text-sm text-primary/80 gap-xs">
