...
export function VoiceSearch({
  ...
  return (
    <div className={cn('flex items-center space-x-sm', className)}>
      ...
      {/* Voice commands help */}
      {isListening && (
        <div className="absolute top-full left-0 right-0 mt-sm p-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 animate-fade-in-up">
          <div className="text-xs text-gray-600 dark:text-gray-400 mb-sm">
            Try saying:
          </div>
          <div className="grid grid-cols-2 gap-sm text-xs">
            <div>
              <div className="font-medium text-gray-800 dark:text-gray-200">Navigation:</div>
            ...
            <div>
              <div className="font-medium text-gray-800 dark:text-gray-200">Actions:</div>
              <div className="text-gray-600 dark:text-gray-400">
  ...
  return (
    <div className={cn('relative flex items-center', className)}>
      <input
        ...
        className="flex-1 px-sm py-sm border border-gray-300 dark:border-gray-600 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white"
      />
      
      <div className="border-t border-b border-r border-gray-300 dark:border-gray-600 rounded-r-lg">
        <VoiceSearch
