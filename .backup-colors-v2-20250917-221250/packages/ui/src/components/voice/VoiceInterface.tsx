...
export function VoiceControls({ className }: { className?: string }) {
  ...
  return (
    <div className={cn('flex items-center space-x-sm', className)}>
      ...
      {currentCommand && (
        <div className="flex items-center space-x-sm px-sm py-xs bg-blue-50 dark:bg-blue-900/20 rounded-lg">
...
export function VoiceCommandSuggestions() {
  ...
  return (
    <div className="fixed bottom-20 left-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-md max-w-sm z-50">
      <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-sm">
        Try saying:
      </h4>
      ...
      <div className="space-y-xs">
        {suggestions.map((suggestion, index) => (
          <button
            ...
            className="w-full text-left p-sm text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors"
          >
            "{suggestion}"
          </button>
        ))}
