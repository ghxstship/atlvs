...
export function Spatial3D({
  ...
  return (
    <div className={cn('relative', className)}>
      <canvas
        ref={canvasRef}
        className="border border-gray-200 dark:border-gray-700 rounded-lg cursor-grab active:cursor-grabbing"
      ...
      {/* Controls overlay */}
      {interactive && (
        <div className="absolute top-2 right-2 bg-white dark:bg-gray-800 rounded-lg p-sm shadow-lg text-xs text-gray-600 dark:text-gray-400">
