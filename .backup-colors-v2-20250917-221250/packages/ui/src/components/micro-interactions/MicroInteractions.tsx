...
export function SuccessFeedback({ children, message = 'Success!', duration = 2000 }: SuccessFeedbackProps) {
  ...
  return (
    <div className="relative">
      ...
      {showFeedback && (
        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-sm py-xs rounded-lg text-sm animate-bounce">
          {message}
...
export function ErrorFeedback({ children, message = 'Error occurred', duration = 3000 }: ErrorFeedbackProps) {
  ...
  return (
    <div className="relative">
      ...
      {showFeedback && (
        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-red-500 text-white px-sm py-xs rounded-lg text-sm animate-shake">
          {message}
...
export function FloatingAction({ children, action, onAction }: FloatingActionProps) {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white px-sm py-xs rounded text-xs whitespace-nowrap animate-float">
          {action}
        </div>
      )}
    </div>
