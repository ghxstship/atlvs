    ...
    <div className={`space-y-md ${className}`}>
      ...
      {validationErrors.length > 0 && (
        <div className="bg-destructive/10 border border-destructive/20 rounded-md p-sm">
          ...
          <ul className="text-sm text-destructive/80 space-y-xs">
      ...
      {/* Create Form */}
      {creatingRecord && (
        <div className="bg-muted border border-border rounded-lg p-md">
          <h3 className="text-lg font-medium mb-md">Create New Record</h3>
          ...
          <table className="w-full">
            <thead className="bg-muted">
              <tr>
                ...
                {fields.map(field => (
                  <th key={field.key} className="px-md py-sm text-left text-sm font-medium text-foreground">
                    {field.label}
                  </th>
                ))}
                <th className="px-md py-sm text-right text-sm font-medium text-foreground">
                  Actions
                </th>
              </tr>
            </thead>
