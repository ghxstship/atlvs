  ...
  return (
    <div className={`text-center py-2xl ${className}`}>
      <div className="flex justify-center mb-md">
        {config.icon || <Database className="h-12 w-12 text-gray-400" />}
      </div>
      
      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-sm">
        {config.title}
      </h3>
      
      <p className="text-gray-600 dark:text-gray-400 mb-lg max-w-md mx-auto">
        {config.description}
      </p>
