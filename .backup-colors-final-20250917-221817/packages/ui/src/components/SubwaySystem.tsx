      ...
      <Button
        ...
        className={twMerge(
          clsx(
            ...
            'shadow-floating hover:shadow-modal',
...
export const SubwayCard = React.forwardRef<HTMLDivElement, SubwayCardProps>(
  ({ line, station, children, className, ...props }, ref) => {
    ...
    return (
      ...
      >
        {station && (
          <div className="flex items-center justify-between mb-md pb-sm border-b border-border/50">
  ...
  ({ line, status, message, className, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={twMerge(
          clsx(
            'flex items-center gap-sm p-sm rounded-lg',
  ...
  ({ lines, className, ...props }, ref) => {
    return (
      <div
        ...
        className={twMerge(
          clsx(
            'p-lg bg-card rounded-xl border border-border/50',
            'space-y-md',
            className
          )
        )}
        {...props}
      >
        <h3 className="font-display text-lg uppercase tracking-wide mb-md">
          System Status
        </h3>
