      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md">
        {summaryStats.map((stat) => (
          <Card key={stat.id} className="p-md">
            ...
            <div className="text-xs text-muted-foreground/60 space-y-xs">
          ...
          <Card key={metric.id} className="p-lg">
            <div className="flex items-center justify-between mb-md">
              <div>
                ...
                <p className="text-sm text-muted-foreground/70">{metric.description}</p>
              </div>
              <div className="flex items-center space-x-sm">
                <div 
            ...
            {metric.threshold && (
              <div className="mt-md flex items-center space-x-md text-xs text-muted-foreground/60">
