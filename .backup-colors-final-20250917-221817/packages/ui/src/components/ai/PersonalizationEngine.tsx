...
export function AISuggestion({ suggestion, onApply, onDismiss }: AISuggestionProps) {
  ...
  return (
    <div className="p-md bg-background dark:bg-muted/90 border border-border dark:border-border rounded-lg shadow-surface">
      <div className="flex items-start justify-between mb-sm">
        <div className="flex items-center space-x-sm">
          <h4 className="text-sm font-medium text-foreground dark:text-background">
            {suggestion.title}
          </h4>
        ...
        <div className="text-xs text-muted-foreground/60 dark:text-muted-foreground/50">
          {Math.round(suggestion.confidence * 100)}% confident
        </div>
      </div>
      
      <p className="text-sm text-muted-foreground/70 dark:text-muted-foreground/40 mb-sm">
