          ...
          <div className="grid md:grid-cols-4 gap-xl max-w-4xl mx-auto">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className={`${anton.className} uppercase text-heading-2 lg:text-heading-1 text-heading-3 color-primary mb-sm`}>
                  {stat.value}
                </div>
            ...
            <Card className="overflow-hidden">
              <div className="h-64 bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center">
                <div className="text-center">
                  <Users className="h-16 w-16 color-primary mx-auto mb-md" />
