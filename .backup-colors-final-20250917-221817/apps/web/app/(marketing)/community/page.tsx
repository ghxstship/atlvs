              ...
              return (
                <Card key={social.name} className="text-center hover:shadow-floating transition-shadow">
                  <CardContent className="p-lg">
                    ...
                    <div className="text-body-sm text-heading-4 color-primary mb-md">
              ...
              return (
                <Card key={achievement.title} className="text-center hover:shadow-floating transition-shadow">
                  <CardContent className="p-xl">
                    ...
                    <div className={`${anton.className} text-heading-3 text-heading-3 color-primary mb-sm uppercase`}>{achievement.metric}</div>
